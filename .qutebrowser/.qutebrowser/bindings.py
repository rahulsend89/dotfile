...
config.bind("<Command-Shift-j>", "set window.hide_decoration true")
config.bind("<Command-Shift-k>", "set window.hide_decoration false")
...
config.bind(";n", "hint links spawn mpv {hint-url}")
